...
public class CdiServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CdiServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CdiServlet at " + request.getContextPath() + "</h1>");
            
            AddDepartmentRequest addDepartmentRequest = new AddDepartmentRequest("cdi_test");
            AddDepartmentResponse addDepartmentResponse =
                        departmentCdiSessionService.addDepartment(addDepartmentRequest);
                
            out.println(departmentCdiSessionService.addDepartment(addDepartmentRequest));
            out.println("</body>");
            out.println("</html>");
        }
    }
